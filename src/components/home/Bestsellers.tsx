    ...
    <section className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-32">
      <div className="mb-12 flex items-end justify-between gap-6 md:mb-16">
        ...
        <Reveal delay={2} className="hidden md:block">
          <Link href="/shop" className="link-sweep font-serif text-sm tracking-widest uppercase pb-1">
            View All Shades →
          </Link>
        </Reveal>
      </div>
      ...
      <div className="mt-12 text-center md:hidden">
        <Link href="/shop" className="font-serif text-xs tracking-widest uppercase inline-block border border-ink px-10 py-4">
          View All Shades
        </Link>
      </div>
    </section>
